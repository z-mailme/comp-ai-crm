	...
	return (
		<div className="flex flex-col gap-10">
			...
			<div className="flex flex-col gap-6">
				<h2 className="font-semibold text-lg">Pipeline analytics</h2>
				<StatGroup>
					<StatCard
				...
				{analytics.pipeline.unconvertedOpen.count > 0 ? (
					<p className="text-muted-foreground text-sm">
						...
						in {analytics.pipeline.unconvertedOpen.currencies.join(", ")} have
						no exchange rate. They count in deal totals but not in value totals.
					</p>
				) : null}
